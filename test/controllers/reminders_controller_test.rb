...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { by_email: @reminder.by_email, by_phone: @reminder.by_phone, time: @reminder.time, user_id: @reminder.user_id }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { by_email: @reminder.by_email, by_phone: @reminder.by_phone, time: @reminder.time, user_id: @reminder.user_id }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
